...
{
    public abstract class CustomAmmoDisplay2 : MonoBehaviour
    {
        ...
        private static bool DoAmmoOverride(GameUIAmmoController uic, GunInventory guns)
        {
            ...
            if (guns == null || !guns.CurrentGun || guns.CurrentGun.GetComponent<CustomAmmoDisplay2>() is not CustomAmmoDisplay2 ammoDisplay)
            ...
            if (uic.m_cachedGun && uic.m_cachedGun.GetComponent<CustomAmmoDisplay2>())
        ...
        private static void ResetUICooldown(GameUIAmmoController uic)
        {
            // reset cooldown sprites
        ...
        private class CustomAmmoDisplayPatch
        {
            ...
            private static void CustomAmmoCountDisplayIL(ILContext il)
            {
                ...
                cursor.Emit(OpCodes.Call, typeof(CustomAmmoDisplay2).GetMethod(
                  nameof(CustomAmmoDisplay2.DoAmmoOverride), BindingFlags.Static | BindingFlags.NonPublic)); // replace with our own custom hook
